  ...
  return (
    <Card className="border-border/60">
      ...
      <CardContent className="p-5 pt-0">
        ...
        <div style={{ width: "100%", height: 320, minHeight: 320 }}><ResponsiveContainer width="100%" height="100%">{children}</ResponsiveContainer></div>
      </CardContent>
    </Card>
  );
}
